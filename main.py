...
def train(args, params):
    ...
    filenames = []
    with open('/home/manh/Datasets/COCO/train2017.txt') as reader:
        for filename in reader.readlines():
            filename = filename.rstrip().split('/')[-1]
            filenames.append('/home/manh/Datasets/COCO/images/train2017/' + filename)

    dataset = COCODataset(filenames, args.input_size, params, True)
    ...
    loader = data.DataLoader(dataset, args.batch_size, sampler is None, sampler,
                             num_workers=8, pin_memory=True, collate_fn=COCODataset.collate_fn)
...
def test(args, params, model=None):
    filenames = []
    with open('/home/manh/Datasets/COCO/val2017.txt') as reader:
        for filename in reader.readlines():
            filename = filename.rstrip().split('/')[-1]
            filenames.append('/home/manh/Datasets/COCO/images/val2017/' + filename)

    dataset = COCODataset(filenames, args.input_size, params, False)
    loader = data.DataLoader(dataset, 8, False, num_workers=8,
                             pin_memory=True, collate_fn=COCODataset.collate_fn)
